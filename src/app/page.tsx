      ...
      <div className="grid grid-flow-row justify-center pt-20 pl-[8px] pr-[8px]">
        <div className="bg-white max-w-[31.625rem] rounded-[20px] px-[36px] md:px-[44px]">
          ...
          <div className="pt-[20px] mb-[11px] md:mb-[50px] text-center">
            {registerBool ? "" : <div className="flex justify-end cursor-pointer"><Image src={backArrow} alt="hi" onClick={handleRegister} /></div>}
          ...
          <div className="">
            ...
            <input className="h-[29px] md:h-[39px] mb-[17px] md:mb-[20px] w-full border-[1px] border-black rounded-[10px] text-[18px] font-[Source-Sans-Pro] pl-[16px]" placeholder="Enter Username" required />
          ...
          <button onClick={handleSubmit} className="text-[20px] font-[DMSerifText] bg-[#2B170C] text-white max-w-[419px] w-full text-center rounded-[10px]">{registerBool ? "Login" : "Create Login"}</button>
