  ...
  return (
    <div className="font-[DMSerifText]">
      ...
      <Modal show={openModal} onClose={() => setOpenModal(false)}>
        <p className="font-[DMSerifText] text-[30px] px-[24px] pt-[15px]">Create Profile</p>
        ...
        <div className="flex justify-end pb-[15px] pr-[24px] pt-[10px]">
            <button onClick={() => setOpenModal(false)} className="text-[30px] bg-[#2B170C] font-[DMSerifText] text-white rounded-[10px] px-[10px] py-[6px] ">Create</button>
        </div>
      </Modal>
    </div>
  );
