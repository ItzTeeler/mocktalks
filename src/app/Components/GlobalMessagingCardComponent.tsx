...
const GlobalMessagingCardComponent = (props: IGChatCard) => {
  ...
  return (
    <>
      <div className='bg-[#696969] m-5 rounded-[15px]' onClick={() => { if (props.isDisabled === false) { props.setIsDisabled(true); props.clickCheck(); props.joinUp(props.namePass, props.room); savePartnerId() } }}>
