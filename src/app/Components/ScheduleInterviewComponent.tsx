        ...
        <Modal.Body className="p-[30px]">
          ...
          <div className="grid grid-cols-2 gap-x-3">
            <div className="flex flex-col gap-5">
              ...
              <button onClick={() => setPracInterview("Data Structure and Algorithms")} className=" py-[30px] border rounded-[10px] text-[20px] font-[DMSerifText] border-black hover:bg-[#757575] focus:bg-[#757575]">
                Data Structure and Algorithms
              </button>
              <button onClick={() => setPracInterview("Applied Data Science")} className=" py-[30px] border rounded-[10px] text-[20px] font-[DMSerifText] border-black focus:bg-[#757575] hover:bg-[#757575]">
                Applied Data Science
              </button>
              <button onClick={() => setPracInterview("Behavioral")} className=" py-[30px] border rounded-[10px] text-[20px] font-[DMSerifText] border-black focus:bg-[#757575] hover:bg-[#757575]">
                Behavioral
              </button>
            </div>
            <div className="flex flex-col gap-5">
              <button onClick={() => setPracInterview("Frontend")} className="px-[10px] py-[30px] border rounded-[10px] text-[20px] font-[DMSerifText] border-black focus:bg-[#757575] hover:bg-[#757575]">
                Frontend
              </button>
              <button onClick={() => setPracInterview("System Design")} className="px-[10px] py-[30px] border rounded-[10px] text-[20px] font-[DMSerifText] border-black focus:bg-[#757575] hover:bg-[#757575]">
                System Design
              </button>
              <button onClick={() => setPracInterview("Practice with a Friend")} className="px-[10px] py-[30px] border rounded-[10px] text-[20px] font-[DMSerifText] border-black focus:bg-[#757575] hover:bg-[#757575]">
